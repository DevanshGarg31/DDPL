...
const WhoWeAre = () => {
    ...
    return (
        <div className={`flex flex-col justify-center items-center py-[80px] ${top ? 'bg-black' : "bg-white"} transition-all duration-500 -mt-10`}>
            ...
            <a href="#_" className={`px-5 py-2.5 relative rounded-3xl mt-10 border-[1px]  group overflow-hidden font-medium ${!top ? 'bg-white text-black border-black' : "bg-black text-white border-white"}  inline-block`}>
